        ...
        return (
            <section className={styles.container}>
                <div className={styles.elements}>
                    ...
                    <div className={styles.icon}>
                        <a href="https://www.freecodecamp.org/patsyguerrero" target="_blank" rel="noreferrer">
                ...
                <div className={styles.copyright}>
                    <span>© 2021 {state? 'Developer by ' : 'Desarrollado por'} Patsy Guerrero {personalData.nickName}</span>
                </div>
            </section>
        );
    };
